...
function Alert(props: AlertProps) {
    ...
    return (
        <Modal open={props.open} onClose={props.onClose} color={bgcolor} titleIcon={icon} titleIconColor={iconcolor} title={props.title} titleColor="white" animationIn={!props.success ? "bounce" : "slideInDown"} >
            <ScrollView>
